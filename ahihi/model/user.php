    ...
    //Khởi tạo thuộc tính cho lớp users
     ...
     //Khai báo phương thức lấy thông tin tài khoản đăng nhập
      ...
      //Khai báo phương thức đăng ký tài khoản
         function insertUser($tmpUsername,$tmpPassword,$tmpName,$tmpEmail)
          { 
            $db = new connect();
            $query = "INSERT INTO users(Username,Password,FullName,Email) VALUES ('$tmpUsername','$tmpPassword','$tmpName','$tmpEmail')";
            $db->exec($query);
          }   
