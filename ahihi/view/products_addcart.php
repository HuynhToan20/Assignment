<?php include "../view/header.php";?>
 ...
 <div class="main_content">
        ...
        ?>
            ...
            <table class="cart_list" style="margin-left:10px;">
        ...
        ?>
          <tr>
             ...
             <td> <?php echo $cost?> </td>
             <td> <img src="../view/images/<?php echo $item['img'];?>" width="100px" /> </td> 
         ...
         <tr>
            ...
            <br/>
             <p>Chọn "Update cart" để cập nhật số lượng hàng. Chọn 0 để bỏ mặt hàng.</p>
                ...
                <tr>
                    <td>
                        <a href="?action=payments"><img src="../view/images/payments.png" width="50"></a><p><b>Thanh toán</b> </p>
                    </td>
                    <td>
                        <a href="?action=home"><img src="../view/images/shop-cart-add-icon.png" width="50"></a><p><b>Thêm sản phẩm</b> </p>
                    </td>
                    <td>
                        <a href="?action=empty_cart"><img src="../view/images/shopping-cart-remove-icon.png" width="50"></a> <p><b>Xóa giỏ hàng</b> </p>
                    </td>
