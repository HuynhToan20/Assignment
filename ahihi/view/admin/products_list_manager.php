    ...
    <center><table border="0" width="840" class="products_list_manager">
        ...
        $result = $quest->getListPage($start,$display);
         ...
         while($set = $result->fetch())
         {
            ...
            echo "<th><img src=".'"'."../view/images/"."$set[ProductImage]".'"'."width=" .'"'."100px" .'"'."/></td>";
            echo "<th>$set[ProductPrice]</th>";
            echo "<th>$set[ProductDesc]</th>";
            echo "<th>$set[ProductCategory]</td>";?>
           <th><a href='?action=update_product&id=<?php echo "$set[ProductID]";?>'><img src="../view/images/update-icon.png" width="35px"/></a></th>
           <th><a href="?action=delete_product&id=<?php echo "$set[ProductID]";?>"><img src="../view/images/delete-icon.png" width="35px"/></a></th>
           </tr>
         <?php } ?>
